...
public class createAccount extends JFrame {
	 ...
	 * @throws SQLException 
	 */
	public createAccount(ArrayList<Flight> flights) throws SQLException {
		...
		lblNewLabel.setBounds(130, 21, 266, 57);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(pass.equals(confirm) && mail.contains("@")) {
					try {
						...
						String dbop = "INSERT INTO USERS VALUES(" + '"' + mail + '"' + "," + '"' + pass + '"' + "," + '"' + fname + '"' + "," + '"' + lname + '"' + "," + '"' + phoneNumber + '"' + "," + '"' + cntry + '"'+ ");";
						stmt.execute(dbop);
						stmt.close();
